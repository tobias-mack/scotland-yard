...
import de.htwg.se.ScotlandYard.model.gameComponents.{Board, Detective, MisterX, Player}
...
class ControllerSpec extends AnyWordSpec with Matchers {
  ...
  "A Controller" when {
    "observed by an Observer" should {
      val board = Board(Vector[Player](MisterX("mrX"),Detective("pl1"),Detective("pl2")))
